...
for rowlist1 in list5:
    rrdict1[rowlist1] = list()
    rrdict2[rowlist1] = list()
...
def permu(rowlists,nu,len1,len2,list3,list4):
    ...
    for rowlist in rowlists:
        ...
        while 1:
            ...
            #print('hello')
            a = {}
            for key in sorted(list31):
                a[key] = list31.count(key)
            
            casepos    = a['11'] if a['11'] else 0
            ontrolpos  = a['21'] if a['21'] else 0
            ...
            print(RR1)
            print(RR2)
            rrdict1[rowlist].append(RR1)
            rrdict2[rowlist].append(RR2)        
...
for rowlist2 in list5:
    ...
    k1 = sum(i > float(srdict1[rowlist2]) for i in rrdict1[rowlist2])
    k2 = sum(j > float(srdict2[rowlist2]) for j in rrdict2[rowlist2])
    if(k1==0):
        k1=1
    if(k2==0):
        k2=1    
